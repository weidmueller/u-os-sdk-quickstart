...
VSC will run doxygen to generate a html folder in the project. Please navigate to index.html in the respective folder with Ubuntu's file explorer and open from there.
...
- A remark regarding the hello_io_world example and example_flatbuffers: 
